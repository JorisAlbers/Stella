...
namespace StellaServerLib.Animation.Drawing.Fade
{
    ...
    public class FadingPulseDrawerWithoutDelta : IDrawerWithoutDelta
    {
        private readonly int _startIndex;
        private readonly int _stripLength;
        private readonly int _frameWaitMs;
        ...
        public FadingPulseDrawerWithoutDelta(int stripLength, int frameWaitMS, Color color, int fadeSteps)
        {
            _stripLength = stripLength;
            _frameWaitMs = frameWaitMS;
            _fadeSteps = fadeSteps;
