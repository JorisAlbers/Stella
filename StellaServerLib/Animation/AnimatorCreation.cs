...
{// Creates an Animator
    public class AnimatorCreation
    {
        ...
        public Animator Create(Storyboard storyboard, int[] stripLengthPerPi, List<PiMaskItem> mask)
        {
            ...
            TransformationController transformationController = new TransformationController(masterTransformationSettings,animationTransformationSettings);
            ...
            if (storyboard.AnimationSettings.Length == 1)// TODO remove this redundant if statement
            {
                ...
                frameProvider = new FrameProvider(drawer, transformationController);
            }
            else
            {
                ...
                frameProvider = new FrameProvider(drawers, relativeTimeStamps, transformationController);
            }

            return new Animator(frameProvider, stripLengthPerPi, mask, transformationController);
        }
