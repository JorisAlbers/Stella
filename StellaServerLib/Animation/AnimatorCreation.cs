...
namespace StellaServerLib.Animation
{
    ...
    {
        public static AnimatorWithoutDelta Create(Storyboard storyboard, int[] stripLengthPerPi, List<PiMaskItem> mask)
        {
            IDrawer drawer;
            ...
            return new AnimatorWithoutDelta(drawer, stripLengthPerPi, mask);
        }
