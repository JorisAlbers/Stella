...
namespace StellaServerLib.Test.Animation.Drawing
{
    ...
    [TestFixture]
    public class TestSlidingPatternDrawerWithoutDelta
    {
        [Test]
        public void Create_ThreeColors_CreatesCorrectFrames()
        {
            ...
            int frameWaitMS = 100;
            int framesToTake = 3;
            SlidingPatternDrawerWithoutDelta drawer = new SlidingPatternDrawerWithoutDelta(lengthStrip, frameWaitMS, pattern);
            ...
            Assert.AreEqual(frame2[6].Color, expectedColor2);
            //Frame 3
            FrameWithoutDelta frame3 = frames[2];
            Assert.AreEqual(lengthStrip, frame3.Count);
            Assert.AreEqual(frameWaitMS * 2, frame3.TimeStampRelative);
            Assert.AreEqual(frame3[0].Color, expectedColor3);
            Assert.AreEqual(frame3[1].Color, expectedColor1);
