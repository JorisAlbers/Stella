...
namespace StellaServerLib.Test.Animation.Drawing
{
    ...
    public class TestRepeatingPatternsDrawer
    {
        ...
        public void Create_singlePattern_CreatesCorrectFrames()
        {
            ...
            int lengthStrip = 7;
            int frameWaitMS = 100;
            RepeatingPatternsDrawer drawer = new RepeatingPatternsDrawer(0,lengthStrip,frameWaitMS,new Color[][]{pattern});
        ...
        public void Create_singlePatternWithStartIndexOf100_CreatesCorrectFrames()
        {
            ...
            int lengthStrip = 7;
            int frameWaitMS = 100;
            RepeatingPatternsDrawer drawer = new RepeatingPatternsDrawer(startIndex,lengthStrip, frameWaitMS, new Color[][] { pattern });
    ...
    [TestFixture]
    public class TestRepeatingPatternsDrawerWithoutDelta
    {
        [Test]
        public void Create_singlePattern_CreatesCorrectFrames()
        {
            ...
            int lengthStrip = 7;
            int frameWaitMS = 100;
            RepeatingPatternsDrawerWithoutDelta drawer = new RepeatingPatternsDrawerWithoutDelta(lengthStrip, frameWaitMS, new Color[][] { pattern });
        ...
        public void Create_TwoPatterns_CreatesFrameListWithTwoFrames()
        {
            ...
            int lengthStrip = 7;
            int frameWaitMS = 100;
            RepeatingPatternsDrawerWithoutDelta drawer = new RepeatingPatternsDrawerWithoutDelta(lengthStrip, frameWaitMS, patterns);
            ...
            //Assert
            FrameWithoutDelta frame1 = frames[0];
            Assert.AreEqual(0, frame1.TimeStampRelative);
            Assert.AreEqual(frame1[0].Color, expectedColor1);
            FrameWithoutDelta frame2 = frames[1];
            Assert.AreEqual(frameWaitMS, frame2.TimeStampRelative);
            Assert.AreEqual(frame2[0].Color, expectedColor2);
        }
    }
