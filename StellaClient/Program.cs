    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                _stellaServer.FrameReceived += Server_OnFrameReceived;
        ...
        private static void Server_OnFrameReceived(object sender, Frame frame)
        {
            _ledController.PrepareFrame(frame);
        }
